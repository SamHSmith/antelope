...
mod tests {
    ...
    rusty_fork_test! {
        ...
        fn fullscreen_triangle() {
            fullscreen_triangle2();
        }

        //#[test]
        fn double_triangle() {
            let win1 = crate::window::main_loop::<DemoTriangleRenderer>();
            let win2 = crate::window::main_loop::<DemoTriangleRenderer>();
    ...
    fn mesh2() {
        let win = crate::window::main_loop::<MeshRenderer>();
